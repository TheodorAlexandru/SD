    ...
    def search(self):
        ...
        if not search_string:
            ...
            if self.author_rb.isChecked():
                url = '/find-and-print?author={}&format={}'.format(search_string.replace(' ', '%20'), format_str)
            elif self.title_rb.isChecked():
                url = '/find-and-print?title={}&format={}'.format(search_string.replace(' ', '%20'), format_str)
            else:
                url = '/find-and-print?publisher={}&format={}'.format(search_string.replace(' ', '%20'), format_str)
