...
// un numar prim este propriul sau cel mai mic factor prim
            ...
            Aceasta bucla se executa doar o singura data pentru umerele care nu sunt prime
            */
            var j = 0
    ...
    //FUNCTIE PT TEMA DE LABORATOR
    fun calculateNUmbersRecursive(n: Int): Int {
        if(n == 0)
            return 1

        val termenAnterior = calculateNUmbersRecursive(n - 1)

        return termenAnterior + 2 * termenAnterior / n
    }
}